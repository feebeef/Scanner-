...
@param {char*} token_class
*/
int file_dump( FILE* outputFile, 
char* lexeme, char* token_class, char* );

/*
Displays error on standard console. Error codes and descriptions are retrieved from error.txt.
